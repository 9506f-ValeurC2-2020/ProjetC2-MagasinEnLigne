 ...
 * @author jalal
 */
public class SingleClientResponse extends ClientResponse {

    private Client response;

    public SingleClientResponse(String status, String message, Client response) {
    ...
    public void setResponse(Client response) {
        this.response = response;
    }
